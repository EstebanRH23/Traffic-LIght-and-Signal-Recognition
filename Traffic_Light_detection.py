...
def image_callback(ros_data):
    ...
    circles_y = cv2.HoughCircles( blur_y , cv2.HOUGH_GRADIENT, 1,20, param1=50, param2=30, minRadius=0, maxRadius=0)
    circles_g = cv2.HoughCircles( blur_g , cv2.HOUGH_GRADIENT, 1,20, param1=50, param2=30, minRadius=0, maxRadius=0)
    ...
    final.format = 'jpeg'
    final.data = np.array(cv2.imencode('.jpg', msk_g)[1]).tostring()
    pub.publish(final)
